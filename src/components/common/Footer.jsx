...
const Footer = () => {
  ...
  <div className="max-w-[1328px] px-3 mx-auto pt-[154px]">
    <div className="relative  flex flex-col md:flex-row gap-10 justify-between pb-10">
      <div>
        <a href="#" className="relative max-w-[194px] h-[48px]  mb-4">
          <Image
            width={195}
            height={48}
    ...
    <p className=' text-xs sm:text-sm my-8 pb-5 font-normal text-start text-light-white opacity-[50%] leading-121'>FUTnext {new Date().getFullYear()}, All rights reserved</p>
    </div>
  </div>
</div>
