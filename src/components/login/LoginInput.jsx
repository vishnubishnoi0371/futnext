...
const LoginInput = ({ onSwitchToSignUp }) => {
    ...
    return (
        <div className='max-w-[376px] mx-auto border p-7 mt-10 w-full'>
            ...
            <p className='font-normal text-xs leading-121 tracking-tighter text-light-white text-center mt-6'>Don’t have an account?<Link href='/Signup' className=' cursor-pointer'>SignUp</Link></p>
