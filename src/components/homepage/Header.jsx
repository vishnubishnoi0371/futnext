...
<CommonButton text="SBC’s" className={`text-light-white bg-black-olive p-[14px_20px] md:p-[16px_24px]`}/>
<CommonButton text="Packs" className={`text-light-white bg-black-olive p-[14px_20px] md:p-[16px_24px]`}/>
<CommonButton text="Recent players" className={`text-light-white bg-black-olive p-[14px_20px] md:p-[16px_24px]`}/>
            </div>
            <SbcsContent/>
        </div>
        </div>
