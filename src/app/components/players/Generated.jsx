                    ...
                    {playersData.map((obj, index) => {
                        return (
                            <div className=' flex w-full justify-center'>
                                <div className='bg-black-olive p-4 w-full rounded-3xl'>
                                    <div className='flex justify-between items-center'>
                                        <div className='flex flex-col'>
                                            <p className=' font-medium text-base lh-[19.36px] text-white'>{obj.title}</p>
                                            <p className=' font-medium text-sm-13 text-dark-white'>{obj.description}</p>
                                        </div>
